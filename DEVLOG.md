...
Planos para hoje:
- Transformar os textView das badges kotlin e python em botões que summonam a pop-up
- Pensar em um melhor design do app. Em dispostivos pequenos as coisas ficam muito "cramped"
